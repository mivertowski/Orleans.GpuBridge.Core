...
public class TemporalProfilingHarness
{
    ...
    public IEnumerable<TemporalPath> GraphFindPaths()
    {
        return _graph!.FindTemporalPaths(
            startNode: 1,
            endNode: 50,
    ...
    public IEnumerable<ulong> GraphGetReachableNodes()
    {
        return _graph!.GetReachableNodes(
            startNode: 1,
            startTimeNanos: 0,
