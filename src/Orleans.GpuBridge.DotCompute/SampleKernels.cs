...
public static class SampleKernels
{
    ...
    /// </summary>
    [Kernel(Name = "vector/add", PreferredWorkGroupSize = 256)]
    ...
    /// </summary>
    [Kernel(Name = "vector/multiply", PreferredWorkGroupSize = 256)]
    ...
    /// </summary>
    [Kernel(Name = "matrix/multiply", PreferredWorkGroupSize = 16, RequiresSharedMemory = true)]
    ...
    /// </summary>
    [Kernel(Name = "reduce/sum", PreferredWorkGroupSize = 128, RequiresAtomics = true)]
    ...
    /// Convolution kernel
    /// </summary>
    [Kernel(Name = "conv/2d", PreferredWorkGroupSize = 32)]
    ...
    /// Softmax kernel
    /// </summary>
    [Kernel(Name = "activation/softmax", PreferredWorkGroupSize = 256)]
    ...
    /// </summary>
    [Kernel(Name = "activation/relu", PreferredWorkGroupSize = 512)]
    ...
    /// </summary>
    [Kernel(Name = "norm/batch", PreferredWorkGroupSize = 128)]
...
public static class ImageKernels
{
    ...
    /// </summary>
    [Kernel(Name = "image/grayscale", PreferredWorkGroupSize = 256)]
    ...
    /// </summary>
    [Kernel(Name = "image/blur", PreferredWorkGroupSize = 16)]
    ...
    /// </summary>
    [Kernel(Name = "image/edges", PreferredWorkGroupSize = 16)]
